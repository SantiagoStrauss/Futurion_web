      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h2 className="text-3xl md:text-4xl font-light tracking-wider mb-4 text-black">Nuestro Blog</h2>
            <p className="text-lg text-black/80 max-w-2xl font-light">
              Compartimos nuestras ideas, investigaciones y perspectivas sobre tecnología, innovación y transformación
              digital.
            </p>
          </motion.div>
          <Button
            variant="outline"
            className="mt-6 md:mt-0 bg-white border-[#780000] text-[#780000] hover:bg-[#780000] hover:text-white"
          >
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-[#780000] text-white text-xs font-medium py-1 px-2 rounded">
                  {post.category}
                </div>
              </div>
              ...
              <div className="flex flex-col p-6 flex-grow">
                ...
                <h3 className="text-xl font-medium mb-3 text-black">{post.title}</h3>

                <p className="text-black/70 mb-6 line-clamp-3">{post.excerpt}</p>

                <a
                  href={post.link}
                  className="inline-flex items-center text-[#780000] hover:text-[#5d0000] transition-colors duration-300 mt-auto group"
                >
