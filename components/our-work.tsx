...
const projects = [
  {
    ...
    description: "Transformando la industria de la moda con soluciones tecnológicas accesibles para todos",
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    title: "TRANSFORMACIONES DIGITALES EN FINTECH",
    description: "Revolucionando el sector financiero con innovaciones tecnológicas de vanguardia",
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    title: "INVERSIONES ESG",
    description: "Desarrollando plataformas para inversiones sostenibles y responsables",
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    title: "CADENA DE SUMINISTRO",
    description: "Optimizando procesos logísticos con soluciones inteligentes y adaptativas",
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    title: "VEHÍCULOS ELÉCTRICOS",
    description: "Impulsando la movilidad sostenible con sistemas de gestión avanzados",
    image: "/placeholder.svg?height=400&width=600",
  },
]
    ...
    <section className="py-32 bg-[#FFFCF2] relative">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-extralight tracking-wider mb-6 text-black">Nuestro Trabajo</h2>
          ...
          <p className="text-lg text-black max-w-3xl mx-auto font-light leading-relaxed mb-12">
            Además de nuestros servicios principales, hemos realizado investigaciones de mercado y desarrollado
            soluciones innovadoras para diversos sectores e industrias emergentes.
          </p>
        </div>
        ...
        <div className="flex justify-center mt-8 space-x-2">
          {projects.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full ${index === currentIndex ? "bg-[#780000]" : "bg-gray-400"}`}
